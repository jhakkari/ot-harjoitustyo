...
class SettingsView:
    ...
    def _initialize_settings_area(self):
        ...
        header_label = ttk.Label(master=self._settings_frame, text="Delete account and data")
        delete_info_label = ttk.Label(master=self._settings_frame, text="This action will:\nDelete all your saved snippets\nDelete your account\nLogout of this application.")
        delete_all_button = ttk.Button(master=self._settings_frame, text="Delete account", command=self._handle_delete_user_and_data)
